...
OPEN_API_DEFAULT_LEASE_SECONDS = int(get_setting("OUTLOOK_MAIL_STATION_OPEN_API_LEASE_SECONDS", "1800") or "1800")
...
OPEN_API_KEY = get_setting("OUTLOOK_MAIL_STATION_OPEN_API_KEY", "")
OPEN_API_BEARER = get_setting("OUTLOOK_MAIL_STATION_OPEN_API_BEARER", "")
